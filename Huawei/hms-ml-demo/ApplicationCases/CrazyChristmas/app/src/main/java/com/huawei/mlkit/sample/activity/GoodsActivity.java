...
import com.huawei.mlkit.sample.views.CustomProgressView;
...
public class GoodsActivity extends AppCompatActivity {
    ...
    private CustomProgressView customprogressBar;
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            switch (msg.what) {
                case START_GAME:
                    ...
                    goodsActivity.customprogressBar.setProgress(goodsActivity.time);
                    goodsActivity.mTiming.setText(goodsActivity.time + "s");
                    break;
                case CHECK_TIME:
                    goodsActivity.time--;
    ...
    private void init() {
        ...
        customprogressBar = findViewById(R.id.customprogress);

        customprogressBar.setProgress(time);
