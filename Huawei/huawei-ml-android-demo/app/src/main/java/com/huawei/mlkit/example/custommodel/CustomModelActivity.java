...
public class CustomModelActivity extends AppCompatActivity {
    private static final String TAG = CustomModelActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        analysisBitmap = BitmapFactory.decodeResource(this.getResources(), R.drawable.custom_model_image, options);
        processBitmap();
    }
     ...
     * Download model.
     *
     * @param remoteModelName Name of the model to be downloaded.
     * @param location        Button switch.
     */
                ...
                .continueWithTask(new Continuation<Boolean, Task<Void>>() {
                    ...
                    public Task<Void> then(Task<Boolean> task) throws Exception {
                        ...
                        try {
                            ...
                            Log.e(TAG, "create MLModelExecutor failed");
                        }
                        return null;
                    }
                });
