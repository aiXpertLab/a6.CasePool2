...
public class ML3DFaceGraphic extends GraphicOverlay.Graphic {
    ...
    public ML3DFaceGraphic(GraphicOverlay overlay, ML3DFace face, Context context) {
        super(overlay);
    ...
    public void draw(Canvas canvas) {
        ...
        float[] adaptMatrix = {frameWidth / 2f, 0, frameWidth / 2f, 0, -frameHeight / 2f, frameHeight / 2f, 0, 0, 1};
        ...
        numPaint.setTextSize(frameHeight / 80f);
