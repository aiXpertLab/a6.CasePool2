...
package com.huawei.mlkit.example.body.handkeypoint;
...
public class StillHandKeyPointAnalyseActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = StillHandKeyPointAnalyseActivity.class.getSimpleName();
    ...
    private void createAnalyzer() {
        ...
        Bitmap originBitmap = BitmapFactory.decodeResource(this.getResources(), R.drawable.handkeypoint_image, options);
