        ...
        task.addOnSuccessListener(new OnSuccessListener<MLImageSegmentation>() {
            ...
            public void onSuccess(MLImageSegmentation imageSegmentationResult) {
                ...
                if (imageSegmentationResult != null) {
                    ...
                    ImageSegmentationStillAnalyseActivity.this.displayFailure("imageSegmentationResult is null.");
                }
            }
            ...
            public void onFailure(Exception e) {
                ...
                ImageSegmentationStillAnalyseActivity.this.displayFailure(e.getMessage());
            }
        });
    }
...
/*        *
        ...
        if (result != null) {
            ...
            this.displayFailure("result is null.");
        }
        ...
        *
        ...
        if (bitmapGray != null) {
            ...
            this.displayFailure("bitmapGray is null.");
        }*/
    }
