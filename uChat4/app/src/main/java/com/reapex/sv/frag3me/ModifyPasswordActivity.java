...
public class ModifyPasswordActivity extends AppCompatActivity{
    ...
    String currentPwd = MySP.getInstance().getString("PASSWORD");
    String wxId = MySP.getInstance().getString("UCHATID");
    ...
    private void submitForm() {
        ...
        MySP.getInstance().saveString("PASSWORD", newPassword);
        db = AChatDB.getDatabase(this);
                db.getUserDao().updatePassword(MySP.getInstance().getString("PHONE"), newPassword);
        finish();
    }
}
