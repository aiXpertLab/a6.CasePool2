...
public class AUser{
    ...
    public AUser(String userPhone, String userNickName, String userPassword, String userAvatarUri, String userWxId, String userGender, String userRegion, String userSignature) {
