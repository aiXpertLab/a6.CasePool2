...
public class MeMore extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        mSexTv.setText(MySP.getInstance().getString("GENDER"));
        mRegionTv.setText(MySP.getInstance().getString("REGION"));
        mSignTv.setText(MySP.getInstance().getString("SIGNATURE"));
    }
