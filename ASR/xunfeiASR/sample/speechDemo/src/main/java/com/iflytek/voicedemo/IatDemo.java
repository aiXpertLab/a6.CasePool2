...
public class IatDemo extends Activity implements OnClickListener {
	...
	private void executeStream() {
		...
		setParam();
		// 设置音频来源为外部文件
//sv		mIat.setParameter(SpeechConstant.AUDIO_SOURCE, "-1");
//sv		mIat.setParameter(SpeechConstant.AUDIO_SOURCE, "IFLY_AUDIO_SOURCE_MIC");
		mIat.setParameter(SpeechConstant.AUDIO_SOURCE, "1");
		//调用本函数开始识别后，通过SDK的录音机录取用户通过麦克风读入的音频（当 SpeechConstant.AUDIO_SOURCE 值>=0时）
